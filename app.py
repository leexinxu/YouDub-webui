...
do_everything_interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label='Video URL', placeholder='Video or Playlist or Channel URL',
                   value='https://www.youtube.com/watch?v=PznJqxon4zE'),  # Changed 'default' to 'value'
        ...
        gr.Radio(['distil-large-v2', 'distil-medium.en', 'large', 'medium', 'small', 'base', 'tiny'], label='Whisper Model', value='distil-large-v2'),
...
whisper_inference = gr.Interface(
    ...
    inputs = [
        gr.Textbox(label='Folder', value='videos_test'),  # Changed 'default' to 'value'
        gr.Radio(['distil-large-v2', 'distil-medium.en', 'large', 'medium', 'small', 'base', 'tiny'], label='Model', value='distil-large-v2'),
